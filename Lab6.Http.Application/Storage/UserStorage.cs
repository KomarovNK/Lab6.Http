...
class TaskStorage : StorageBase<TaskItem>, ITaskApi
{
    private static readonly Dictionary<int, TaskItem> defaultData
        ...
        {
            [1] = new TaskItem(1, "Julie Walker", "Off"),
            [2] = new TaskItem(2, "Maria Smith", "Off"),
            [3] = new TaskItem(3, "Sharon Williams", "Off"),
            [4] = new TaskItem(4, "Ann Morris", "Off"),
            [5] = new TaskItem(5, "Mary Harris", "Off"),
        };
